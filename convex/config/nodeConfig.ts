...
const nodeDataConfig: Array<NodeDataConfigItem> = [
  ...
  },
  {
    ...
    label: "App",
    description:
      "Node for interactive React apps: prototypes, UI mockups, dashboards, charts, calculators...",
    llmDescription:
