...
function SkillsSettingsPage() {
  ...
  return (
    <div className="flex h-full min-h-0 flex-col gap-6">
      <PageHeader
        title="Skills"
        subtitle="Reusable prompt modules Nolë can load on demand. Define the name, description, and body for discovery and usage."
        action={
          <Button type="button" onClick={handleNewSkill}>
            <TbPlus />
            New skill
          </Button>
        }
